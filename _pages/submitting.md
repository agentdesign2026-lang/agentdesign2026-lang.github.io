...
To create a blog post in Markdown format, you can modify the [example]({% post_url 2026-04-27-content-promotion-agent-design %}) Markdown post `_posts/2026-04-27-content-promotion-agent-design.md` and rename it to `_posts/2026-04-27-[SUBMISSION NAME].md`, where `[SUBMISSION NAME]` is the name of your submission. You can see the result of the sample post .
...
Read our [sample blog post]({% post_url 2026-04-27-content-promotion-agent-design %}) carefully to see how you can add image assets, and how to write using $$\LaTeX$$!
...
2. Double check that your post matches the formatting requirements, including (but not limited to):
   ...
   - Have a short 2-3 sentence abstract in the `description` field of your front-matter ([example](https://github.com/iclr-blogposts/2026/blob/main/_posts/2026-04-27-content-promotion-agent-design.md?plain=1#L4-L6))
   ...
   - Have a table of contents, formatted using the `toc` field of your front-matter ([example](https://github.com/iclr-blogposts/2026/blob/main/_posts/2026-04-27-content-promotion-agent-design.md?plain=1#L36-L47))
