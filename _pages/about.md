...
The posts will be created and published under a unified template; see [the submission instructions]({{ '/submitting' | relative_url }}) and the [sample post]({% post_url 2026-04-27-content-promotion-agent-design %}) hosted on the blog of this website.
